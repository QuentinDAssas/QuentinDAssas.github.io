...
class Resources extends Controller 
{
   ...
   /**
    ...
    public function index() {
        ...
        //affichage
        \Renderer::render("Resources", compact('libraries','mediaLibraries','mediaLoirets','linksLoiret','linksMaternity','linksAssociations','linksOther','pregnancys','feminisms','postnatalLibraries','youths'));
