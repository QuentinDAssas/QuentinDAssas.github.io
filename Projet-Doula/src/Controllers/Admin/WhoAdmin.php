...
class WhoAdmin extends \Controllers\Admin 
{
   ...
   /**
    ...
    public function index() 
    {
        ...
        //affichage
        \Renderer::showAdmin("whoAdmin", compact('presentationsCol1','presentationsCol2','legends','whoCitations','mediaFormations','formations','confs','mediaFigcaptions'));
